...
object ProductTemplates {
    ...
    val NORMAL_PRODUCTS = listOf(
        ...
        ProductTemplate("Oyuncu Laptopu", "Electronics", "gaming_laptop_new", 15000, 30000),
        ProductTemplate("Oyun Konsolu", "Electronics", "game_console_new", 4000, 8000),
        ProductTemplate("Tarihi Roma Sikkesi", "Hobby", "ancient_coin", 5000, 15000),
        ...
        ProductTemplate("Oltu Taşı Tesbih", "Accessories", "bez_canta", 500, 1500),
        ProductTemplate("Gözyaşı Pırlanta Yüzük", "Accessories", "luxury_watch", 10000, 50000),
        ProductTemplate("Gümüş İşlemeli Pusula", "Accessories", "classic_watch", 800, 2500),
        ...
        ProductTemplate("Gözyaşı Kolyesi", "Accessories", "luxury_watch", 2000, 8000),
        ...
        ProductTemplate("Folyolu Altın Sikke", "Hobby", "ancient_coin", 50, 200),
