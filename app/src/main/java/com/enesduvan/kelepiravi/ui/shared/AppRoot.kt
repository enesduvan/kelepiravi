...
fun AppRoot(viewModel: MarketViewModel) {
    ...
    if (bargainState != null) {
        BargainScreen(viewModel = viewModel, bargainState = bargainState!!)
    } else if (sellBargainState != null) {
        SellBargainScreen(viewModel = viewModel, sellBargainState = sellBargainState!!)
    } else {
        Scaffold(
